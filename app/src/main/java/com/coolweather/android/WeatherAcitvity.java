...
public class WeatherAcitvity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefresh = (SwipeRefreshLayout)findViewById(R.id.swipie_refresh);
        ...
        public void requestWeather(final String weatherId){
            String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=ca7b8d0adf4a480c91f904f185174bbc";
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (weather != null&&"ok".equals(weather.status)){
                                ...
                                Toast.makeText(WeatherAcitvity.this,"获取天气信息失败1111",Toast.LENGTH_SHORT).show();
                            }
                            swipeRefresh.setRefreshing(false);
                        }
                    });
